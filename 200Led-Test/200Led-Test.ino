...
int LN = 200; // Numbers of LEDs used
int LB=100; //Brightness LED

byte LEDPos[200]; // Led Array. Always a higher Number than LN
...
for (int a = 1; a <= 6; a++) {  
                                for (int i = 0; i <= 199; i++) {
                                  LEDPos[i]=a; // Led on Pos i goes on
                                  UpdateLEDs(); // Execute the settings
                                  delay(5); // wait 5ms
                                  //LEDPos[i]=0; // Led on Pos i goes off
